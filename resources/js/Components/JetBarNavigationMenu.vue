        ...
        <div class="flex items-center">
            ...
            <div class="relative">
                ...
                <div v-show="showingUserDropdown"
                    ...
                    <a :href="route('profile.show')" class="block px-4 py-2 text-sm text-gray-500 hover:bg-gray-100">Profile</a>

                    <a :href="route('api-tokens.index')" v-if="$page.props.jetstream.hasApiFeatures" class="block px-4 py-2 text-sm text-gray-500 hover:bg-gray-100">API Tokens</a>
